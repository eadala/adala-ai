...
| `026_promo_schema_authority.sql` | Formal `promo_codes` + `gift_subscriptions` (Stage 16.3). Fixes `GET /api/promo/my-gift` 500 when tables absent. |
...
| `gift_subscriptions` | **026** | `GET /promo/my-gift`, office subscription gift check |
