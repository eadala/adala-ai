...
export const DEFAULT_PLANS = [
  {
    ...
    features: ["٥ قضايا نشطة", "مستخدم واحد", "١ جيجا تخزين آمن", "٥ طلبات AI يومياً", "تذكيرات ذكية بالمواعيد القانونية", "تقويم قانوني مدمج", "تصدير PDF احترافي"],
    featureFlags: { cases: true, invoices: true, reminders: true, calendar: true, exportPdf: true, reportsBasic: true, aiBasic: true, ai: false, aiAnalytics: false, aiCfo: false, customAiTraining: false, documentTemplates: false, contractsAi: false, ocr: false, backup: false, website: true, serviceStore: true, payments: true, mobileApp: false, whatsapp: false, workflow: false, reportsAdvanced: false, clientPortal: false, customDomain: false, apiAccess: false, whiteLabel: false, sla: false, dedicatedManager: false, priorityInfrastructure: false },
    limits: { users: 1, storage: "١ GB", aiRequests: 5, branches: 0 },
  },
  {
    ...
    features: ["٢٠ قضية نشطة", "مستخدمان", "٥ جيجا تخزين", "٢٠ طلب AI يومياً", "فواتير إلكترونية احترافية", "بوابة استلام المدفوعات", "موقع فرعي من عدالة", "متجر خدماتك القانونية", "قوالب عقود ومستندات جاهزة"],
    ...
    limits: { users: 2, storage: "٥ GB", aiRequests: 20, branches: 0 },
  },
  {
    ...
    features: ["١٠٠ قضية نشطة", "٥ مستخدمين", "٢٥ جيجا تخزين", "١٠٠ طلب AI يومياً", "كل مزايا انطلق +", "🤖 عقود ذكية بالذكاء الاصطناعي", "💬 WhatsApp Business", "📲 Telegram", "🔐 بوابة العملاء الذكية", "تحليلات AI متقدمة", "OCR - استخراج النصوص", "نسخ احتياطي تلقائي يومي"],
    featureFlags: { cases: true, invoices: true, reminders: true, calendar: true, exportPdf: true, reportsBasic: true, aiBasic: true, ai: true, aiAnalytics: true, aiCfo: false, customAiTraining: false, documentTemplates: true, contractsAi: true, ocr: true, backup: true, website: true, serviceStore: true, payments: true, mobileApp: true, whatsapp: true, workflow: false, reportsAdvanced: true, clientPortal: false, customDomain: false, apiAccess: false, whiteLabel: false, sla: false, dedicatedManager: false, priorityInfrastructure: false },
    limits: { users: 5, storage: "٢٥ GB", aiRequests: 100, branches: 0 },
  },
  {
    ...
    features: ["٥٠٠ قضية نشطة", "١٥ مستخدماً", "١٠٠ جيجا تخزين", "٣٠٠ طلب AI يومياً", "كل مزايا أتقن +", "🏢 ٣ فروع مستقلة", "⚙️ محرك سير العمل الآلي", "👥 إدارة الموظفين", "📊 تقارير أداء متقدمة"],
    ...
    limits: { users: 15, storage: "١٠٠ GB", aiRequests: 300, branches: 3 },
  },
  {
    ...
    features: ["٢٠٠٠ قضية نشطة", "٣٠ مستخدماً", "٢٠٠ جيجا تخزين", "١٠٠٠ طلب AI يومياً", "كل مزايا توسّع +", "🌐 نطاق خاص مخصص", "🔌 وصول API كامل", "🧠 مساعد مالي AI (CFO)", "🏷️ علامة تجارية بيضاء"],
    ...
    limits: { users: 30, storage: "٢٠٠ GB", aiRequests: 1000, branches: 10 },
  },
  {
    ...
    features: ["قضايا غير محدودة", "١٠٠ مستخدم", "١ تيرابايت تخزين", "AI غير محدود", "فروع غير محدودة", "🤝 مدير حساب مخصص", "🛡️ SLA مضمون ٢٤/٧", "🔗 تكاملات مخصصة", "🎓 تدريب وإعداد شامل"],
    ...
    limits: { users: 100, storage: "١ TB", aiRequests: "unlimited", branches: "unlimited" },
  },
  {
    ...
    features: ["كل شيء بلا حدود ولا قيود", "🤖 AI مدرَّب خصيصاً على بيانات مكتبك", "🏗️ بنية تحتية مخصصة ومعزولة بالكامل", "📜 SLA ٩٩.٩٩٪ بعقد قانوني ملزم", "🌟 مدير نجاح مخصص ٢٤/٧", "🚀 هجرة بياناتك مجاناً", "🔒 أعلى معايير الأمان"],
