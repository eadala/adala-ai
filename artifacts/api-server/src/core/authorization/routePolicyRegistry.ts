...
/** Policies — PR-AUTH-001..003 + PR-HR-EXT + PR-AI-002. */
export const ROUTE_POLICIES: RoutePolicy[] = [
  ...
  { method: "GET", path: "/api/payments/connect/status", routeClass: "TENANT_RBAC", permission: "payments:view" },
  { method: "POST", path: "/api/payments/connect/create", routeClass: "TENANT_RBAC", permission: "payments:create" },
  { method: "POST", path: "/api/payments/connect/onboarding", routeClass: "TENANT_RBAC", permission: "payments:create" },
  { method: "POST", path: "/api/payments/connect/login-link", routeClass: "TENANT_RBAC", permission: "payments:create" },
  { method: "POST", path: "/api/payments/intent", routeClass: "TENANT_RBAC", permission: "payments:create" },
  ...
  { method: "PATCH", path: "/api/payments/transactions/:id/status", routeClass: "TENANT_RBAC", permission: "payments:create" },
  { method: "PATCH", path: "/api/payments/transactions/:id/settle", routeClass: "TENANT_RBAC", permission: "payments:create" },
  { method: "POST", path: "/api/payments/batch-settle", routeClass: "TENANT_RBAC", permission: "payments:create" },
  { method: "DELETE", path: "/api/payments/transactions/:id", routeClass: "TENANT_RBAC", permission: "payments:create" },
  { method: "GET", path: "/api/payments/wallet", routeClass: "TENANT_RBAC", permission: "payments:view" },
  { method: "GET", path: "/api/payments/stats", routeClass: "TENANT_RBAC", permission: "payments:view" },
  { method: "GET", path: "/api/payments/moyasar/settings", routeClass: "TENANT_RBAC", permission: "payments:view" },
  { method: "PUT", path: "/api/payments/moyasar/settings", routeClass: "TENANT_RBAC", permission: "payments:create" },
  { method: "POST", path: "/api/payments/payment-link", routeClass: "TENANT_RBAC", permission: "payments:create" },
  { method: "GET", path: "/api/payments/checkout/settings", routeClass: "TENANT_RBAC", permission: "payments:view" },
  { method: "PUT", path: "/api/payments/checkout/settings", routeClass: "TENANT_RBAC", permission: "payments:create" },
  { method: "POST", path: "/api/payments/checkout/create-payment", routeClass: "TENANT_RBAC", permission: "payments:create" },
