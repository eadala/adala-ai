...
import smartDocumentsRouter    from "../modules/legal-core/smart-documents";
...
import aiWorkflowBuilderRouter from "../modules/ai/aiWorkflowBuilder";
...
import tenantDebugRouter     from "../modules/platform/tenantDebug";
...
import supportEnterpriseRouter from "../modules/platform/support-enterprise";
...
import certificationRouter    from "../modules/platform/certification";
...
import demoSyncRouter        from "../modules/platform/demo-sync";
...
router.use(smartDocumentsRouter);
...
router.use(aiWorkflowBuilderRouter);
...
router.use(supportEnterpriseRouter);
