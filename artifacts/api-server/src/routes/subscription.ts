  ...
  try {
    ...
    if (!plan) {
      return res.json({
        ...
        planColor: "#C9A84C",
        featureFlags: {
          ai: true, clientPortal: false, officePage: true,
          legalStore: false, apiAccess: false, seo: false,
          whatsapp: false, branches: false, workflow: false,
          sla: false, customDomain: false, advancedReports: false,
          calendar: true, whiteLabel: false,
        },
