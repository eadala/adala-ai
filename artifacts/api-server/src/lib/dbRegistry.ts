...
export const DB_REGISTRY: DBTableDefinition[] = [
  ...
  },
  {
    ...
    keyColumns: [
      ...
      { name: "status", type: "TEXT", required: true },
      { name: "payment_provider", type: "TEXT", required: false },
      { name: "payment_status", type: "TEXT", required: false },
      { name: "transaction_reference", type: "TEXT", required: false, isIndex: true },
    ...
    requiredIndexes: [
      "idx_payment_transactions_office_id",
      "idx_payment_transactions_transaction_reference",
    ],
    migrationFile: "002_payment_gateway_metadata.sql",
