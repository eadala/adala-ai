...
export const DB_REGISTRY: DBTableDefinition[] = [
  ...
  },
  {
    ...
    keyColumns: [
      { name: "id", type: "SERIAL", required: true },
      { name: "office_id", type: "TEXT", required: true, isIndex: true },
      { name: "amount", type: "NUMERIC(18,2)", required: true },
      { name: "provider", type: "TEXT", required: true },
      { name: "status", type: "TEXT", required: true },
      { name: "settlement_status", type: "TEXT", required: false },
      { name: "stripe_fee", type: "NUMERIC(18,2)", required: false },
      { name: "net_amount", type: "NUMERIC(18,2)", required: false },
      { name: "platform_fee", type: "NUMERIC(18,2)", required: false },
    ],
