import{a as i,j as e}from"./vendor-react-CT0_hoX6.js";import{n as Z,b as ee,a as L,c as $,S as C,T as ae,B as h,h as le,i as te,j as ie}from"./index-CBK7_TbS.js";import{u as se,b as oe}from"./vendor-tanstack-BdGrscrn.js";import{C as re}from"./card-XWGgBzGJ.js";import{I as d}from"./input-kUNPXuRY.js";import{L as b}from"./label-DKqhe16J.js";import{A as ne,a as de}from"./adaptive-dialog-tLYhLUm2.js";import{a6 as ce,F as u,S as pe,a7 as me,D as xe,B as he,an as be,e as U,br as ge,bn as ue,aq as S,o as fe,E as ye,H as ve,b as je}from"./vendor-icons-BFrUBqiJ.js";import"./vendor-router-DkVvMFVl.js";import"./vendor-charts-CneYNIhr.js";import"./vendor-i18n-lBdt9ta2.js";import"./vendor-clerk-C3c0VrlK.js";import"./use-breakpoint-l8ceMopP.js";const I=[{id:"all",label:"الكل",icon:u},{id:"judicial",label:"قضائية",icon:pe},{id:"contractual",label:"تعاقدية",icon:me},{id:"financial",label:"مالية",icon:xe},{id:"admin",label:"إدارية",icon:he}],R=[{id:"legal-warning",title:"خطاب إنذار قانوني",category:"judicial",description:"إنذار رسمي قبل اتخاذ الإجراءات القانونية",fields:[{key:"recipient_name",label:"اسم المستلم",placeholder:"عبدالله محمد الشمري"},{key:"recipient_title",label:"صفة المستلم",placeholder:"المدير العام"},{key:"recipient_company",label:"جهة المستلم",placeholder:"شركة النور للتجارة"},{key:"amount",label:"المبلغ المطالب به",placeholder:"٥٠,٠٠٠ ريال سعودي"},{key:"debt_reason",label:"سبب المطالبة",placeholder:"فاتورة خدمات غير مسددة"},{key:"days",label:"مهلة السداد (يوم)",placeholder:"١٥"},{key:"client_name",label:"اسم الموكّل",placeholder:"أحمد سعد القحطاني"}],body:`بسم الله الرحمن الرحيم
...
**{{lawyer_name}}**`}];function _e(f,c){return f.replace(/\{\{(\w+)\}\}/g,(E,s)=>c[s]||`[${s}]`)}const ke=new Date().toLocaleDateString("ar-SA-u-ca-islamic",{day:"numeric",month:"long",year:"numeric"});function Ie(){const{data:f}=Z(),[c,E]=i.useState("all"),[s,P]=i.useState(""),[t,B]=i.useState(null),[y,v]=i.useState({}),[T,j]=i.useState(!1),[M,_]=i.useState(!1),[o,q]=i.useState(""),[z,O]=i.useState(""),[p,D]=i.useState(""),[A,H]=i.useState(""),Q=i.useRef(null),{toast:m}=ee(),{data:x}=se({queryKey:["smtp-status"],queryFn:()=>fetch("/api/email/smtp-status").then(a=>{if(!a.ok)throw new Error("خطأ في الخادم");return a.json()})}),k=oe({mutationFn:a=>fetch("/api/email/send-letter",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(a)}).then(l=>{if(!l.ok)throw new Error("خطأ في الخادم");return l.json()}),onSuccess:a=>{if(a.mailtoFallback){const l=`mailto:${o}?subject=${encodeURIComponent(p)}&body=${encodeURIComponent(r.replace(/\*\*(.*?)\*\*/g,"$1"))}`;window.open(l,"_blank"),m({title:"فُتح برنامج البريد",description:"أكمل الإرسال من برنامج البريد لديك"})}else a.success?(m({title:"✅ تم الإرسال بنجاح",description:`تم إرسال الخطاب إلى ${o}`}),_(!1)):m({title:"فشل الإرسال",description:a.error,variant:"destructive"})},onError:()=>m({title:"خطأ في الإرسال",variant:"destructive"})});function Y(){t&&D(t.title),_(!0)}function G(){k.mutate({to:o,toName:z,subject:p,body:r,fromName:A})}function J(){const a=`mailto:${o}?subject=${encodeURIComponent(p)}&body=${encodeURIComponent(r.replace(/\*\*(.*?)\*\*/g,"$1"))}`;window.open(a,"_blank")}const F=R.filter(a=>!(c!=="all"&&a.category!==c||s&&!a.title.includes(s)&&!a.description.includes(s)));function K(a){B(a),v({}),j(!1)}const r=t?_e(t.body,{...y,date:ke}):"";function V(){navigator.clipboard.writeText(r).then(()=>{j(!0),setTimeout(()=>j(!1),2e3),m({title:"تم نسخ الخطاب ✓"})})}function W(){const a=window.open("","_blank");if(!a)return;const l=f,n=l?.letterheadUrl,g=l?.primaryColor||"#1e3a5f",w=l?.secondaryColor||"#2563EB",N=l?.officeName||"مكتب المحاماة",X=l?.showAdalalahFooter!==!1;a.document.write(`<!DOCTYPE html>
...
.office-name{font-size:20pt;font-weight:900;color:${g};line-height:1.1}
...
<div class="page-inner">
  <div class="office-header">
    <div class="office-brand">
      ${l?.logoUrl?`<img src="${l.logoUrl}" alt="شعار" class="office-logo"/>`:`<div style="width:50px;height:50px;border-radius:10px;background:${g};display:flex;align-items:center;justify-content:center;color:#fff;font-size:18pt;font-weight:900">${N[0]}</div>`}
      <div>
...
`)}</div>
  ...
  <div style="display:flex;justify-content:space-between;margin-top:48px;padding-top:16px;border-top:1px solid #ddd">
    <div style="text-align:center;width:160px">
      ...
      <div style="font-size:9pt;font-weight:700;margin-top:4px;color:${g}">${N}</div>
    </div>
  ...
  ${X?`<div class="footer" style="margin-top:20px">تم إنشاء هذا الخطاب بواسطة منصة عدالة AI · ${l?.website||""}</div>`:l?.website?`<div class="footer" style="margin-top:20px">${l.website}</div>`:""}
</div>
</div>
<script>window.addEventListener('load',()=>setTimeout(()=>window.print(),500))<\/script>
</body></html>`),a.document.close()}return e.jsxs("div",{className:"space-y-6 h-full",children:[e.jsxs("div",{className:"flex items-center justify-between flex-wrap gap-3",children:[e.jsxs("div",{children:[e.jsx("h1",{className:"text-2xl font-black",children:"نماذج الخطابات والمراسلات"}),e.jsx("p",{className:"text-muted-foreground text-sm",children:"نماذج قانونية جاهزة قابلة للتخصيص"})]}),e.jsxs(L,{variant:"outline",className:"border-primary/30 text-primary",children:[R.length," نموذج جاهز"]})]}),e.jsxs("div",{className:"grid grid-cols-1 lg:grid-cols-3 gap-4 h-[calc(100vh-200px)] min-h-[600px]",children:[e.jsxs("div",{className:"flex flex-col gap-3",children:[e.jsxs("div",{className:"relative",children:[e.jsx(ce,{className:"absolute right-3 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground"}),e.jsx(d,{value:s,onChange:a=>P(a.target.value),placeholder:"بحث في النماذج...",className:"pe-9"})]}),e.jsx("div",{className:"flex flex-wrap gap-1.5",children:I.map(a=>e.jsx("button",{onClick:()=>E(a.id),className:$("px-3 py-1 rounded-full text-xs font-semibold border transition-all",c===a.id?"bg-primary text-primary-foreground border-primary":"border-border text-muted-foreground hover:border-primary/50 hover:text-primary"),children:a.label},a.id))}),e.jsx(C,{className:"flex-1",children:e.jsxs("div",{className:"space-y-2 ps-1",children:[F.map(a=>e.jsx("button",{onClick:()=>K(a),className:$("w-full text-right p-3 rounded-xl border transition-all hover:border-primary/40",t?.id===a.id?"bg-primary/10 border-primary/50":"bg-card/50 border-border/50 hover:bg-muted/30"),children:e.jsxs("div",{className:"flex items-start gap-2",children:[e.jsx(u,{className:$("h-4 w-4 mt-0.5 shrink-0",t?.id===a.id?"text-primary":"text-muted-foreground")}),e.jsxs("div",{className:"flex-1 min-w-0",children:[e.jsx("div",{className:"font-semibold text-sm leading-tight",children:a.title}),e.jsx("div",{className:"text-[11px] text-muted-foreground mt-0.5 leading-snug",children:a.description}),e.jsx(L,{variant:"outline",className:"mt-1.5 text-[9px] px-1.5 py-0",children:I.find(l=>l.id===a.category)?.label})]}),t?.id===a.id&&e.jsx(be,{className:"h-4 w-4 text-primary shrink-0"})]})},a.id)),F.length===0&&e.jsxs("div",{className:"text-center py-10 text-muted-foreground text-sm",children:[e.jsx(u,{className:"h-8 w-8 mx-auto mb-2 opacity-30"}),"لا توجد نماذج مطابقة"]})]})})]}),e.jsx("div",{className:"flex flex-col gap-3",children:t?e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"p-3 rounded-xl bg-primary/5 border border-primary/20",children:[e.jsx("div",{className:"font-bold text-sm text-primary",children:t.title}),e.jsx("div",{className:"text-[11px] text-muted-foreground",children:t.description})]}),e.jsx(C,{className:"flex-1",children:e.jsx("div",{className:"space-y-3 ps-1",children:t.fields.map(a=>e.jsxs("div",{children:[e.jsx(b,{className:"text-xs font-semibold mb-1 block",children:a.label}),a.multiline?e.jsx(ae,{value:y[a.key]??"",onChange:l=>v(n=>({...n,[a.key]:l.target.value})),placeholder:a.placeholder,className:"text-sm resize-none",rows:3}):e.jsx(d,{value:y[a.key]??"",onChange:l=>v(n=>({...n,[a.key]:l.target.value})),placeholder:a.placeholder,className:"text-sm"})]},a.key))})})]}):e.jsxs("div",{className:"flex-1 flex flex-col items-center justify-center text-center text-muted-foreground gap-3",children:[e.jsx(u,{className:"h-12 w-12 opacity-20"}),e.jsx("div",{className:"text-sm",children:"اختر نموذجاً من القائمة لتعبئة بياناته"})]})}),e.jsx("div",{className:"flex flex-col gap-3",children:t?e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"flex items-center gap-1.5 flex-wrap",children:[e.jsx("span",{className:"text-xs font-semibold text-muted-foreground flex-1",children:"معاينة الخطاب"}),e.jsxs(h,{size:"sm",variant:"outline",onClick:V,className:"h-7 text-xs gap-1.5",children:[T?e.jsx(U,{className:"h-3.5 w-3.5 text-emerald-400"}):e.jsx(ge,{className:"h-3.5 w-3.5"}),T?"تم النسخ":"نسخ"]}),e.jsxs(h,{size:"sm",variant:"outline",onClick:W,className:"h-7 text-xs gap-1.5",children:[e.jsx(ue,{className:"h-3.5 w-3.5"})," طباعة"]}),e.jsxs(h,{size:"sm",onClick:Y,className:"h-7 text-xs gap-1.5 bg-primary hover:bg-primary/90",children:[e.jsx(S,{className:"h-3.5 w-3.5"})," إرسال بالبريد"]})]}),e.jsx(re,{className:"flex-1 border-border/50",children:e.jsx(C,{className:"h-full",children:e.jsx("div",{ref:Q,className:"p-5 text-sm leading-8 whitespace-pre-wrap font-[Cairo,sans-serif]",dangerouslySetInnerHTML:{__html:r.replace(/\*\*(.*?)\*\*/g,"<strong>$1</strong>").replace(/\[(\w+)\]/g,'<span class="bg-yellow-500/20 text-yellow-400 px-1 rounded text-xs">[$1]</span>')}})})})]}):e.jsxs("div",{className:"flex-1 rounded-xl border border-dashed border-border/40 flex flex-col items-center justify-center text-center text-muted-foreground gap-3",children:[e.jsx(fe,{className:"h-10 w-10 opacity-20"}),e.jsx("div",{className:"text-sm",children:"ستظهر معاينة الخطاب هنا"})]})})]}),e.jsx(ne,{open:M,onOpenChange:_,children:e.jsxs(de,{className:"max-w-md",children:[e.jsx(le,{children:e.jsxs(te,{className:"flex items-center gap-2",children:[e.jsx(S,{className:"h-4 w-4 text-primary"}),"إرسال الخطاب بالبريد الإلكتروني"]})}),x&&!x.configured&&e.jsxs("div",{className:"flex items-start gap-2 p-3 rounded-lg bg-yellow-500/10 border border-yellow-500/20 text-xs text-yellow-300",children:[e.jsx(ye,{className:"h-3.5 w-3.5 mt-0.5 shrink-0"}),e.jsx("span",{children:"لم يتم إعداد خادم البريد (SMTP) بعد — سيُفتح برنامج بريدك الإلكتروني تلقائياً لإكمال الإرسال."})]}),x?.configured&&e.jsxs("div",{className:"flex items-center gap-2 p-2.5 rounded-lg bg-emerald-500/10 border border-emerald-500/20 text-xs text-emerald-300",children:[e.jsx(U,{className:"h-3.5 w-3.5 shrink-0"}),"خادم البريد مُهيّأ — سيتم الإرسال مباشرة"]}),e.jsxs("div",{className:"space-y-3",children:[e.jsxs("div",{children:[e.jsx(b,{className:"text-xs font-semibold mb-1 block",children:"البريد الإلكتروني للمستلم *"}),e.jsx(d,{type:"email",value:o,onChange:a=>q(a.target.value),placeholder:"client@example.com",dir:"ltr"})]}),e.jsxs("div",{children:[e.jsx(b,{className:"text-xs font-semibold mb-1 block",children:"اسم المستلم"}),e.jsx(d,{value:z,onChange:a=>O(a.target.value),placeholder:"محمد عبدالله"})]}),e.jsxs("div",{children:[e.jsx(b,{className:"text-xs font-semibold mb-1 block",children:"موضوع الرسالة *"}),e.jsx(d,{value:p,onChange:a=>D(a.target.value),placeholder:t?.title??"موضوع الخطاب"})]}),e.jsxs("div",{children:[e.jsx(b,{className:"text-xs font-semibold mb-1 block",children:"اسم المُرسِل / المكتب"}),e.jsx(d,{value:A,onChange:a=>H(a.target.value),placeholder:"مكتب المحاماة / اسم المحامي"})]}),e.jsxs("div",{className:"rounded-lg bg-muted/30 border border-border/40 p-3 text-xs text-muted-foreground leading-6 max-h-24 overflow-hidden relative",children:[e.jsxs("div",{className:"line-clamp-3",children:[r.replace(/\*\*/g,"").slice(0,200),"..."]}),e.jsx("div",{className:"absolute bottom-0 left-0 right-0 h-6 bg-gradient-to-t from-background/80 to-transparent"})]})]}),e.jsxs(ie,{className:"gap-2 flex-col sm:flex-row",children:[!x?.configured&&e.jsxs(h,{variant:"outline",onClick:J,disabled:!o,className:"gap-2 flex-1",children:[e.jsx(S,{className:"h-4 w-4"})," فتح في برنامج البريد"]}),e.jsxs(h,{onClick:G,disabled:!o||!p||k.isPending,className:"gap-2 flex-1",children:[k.isPending?e.jsx(ve,{className:"h-4 w-4 animate-spin"}):e.jsx(je,{className:"h-4 w-4"}),x?.configured?"إرسال الآن":"إرسال عبر البريد"]})]})]})})]})}export{Ie as default};
