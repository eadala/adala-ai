import{a as i,j as e}from"./vendor-react-CT0_hoX6.js";import{o as ee,d as ae,b as L,c as $,S as C,T as le,B as h,i as te,j as ie,k as se,a as U}from"./index-DbH-iyao.js";import{u as oe,b as re}from"./vendor-tanstack-BdGrscrn.js";import{C as ne}from"./card-CXQ10W_J.js";import{I as d}from"./input-dXNg9Rh5.js";import{L as b}from"./label-Bfu6jZgu.js";import{A as de,a as ce}from"./adaptive-dialog-xlnbxJ3I.js";import{a6 as pe,F as g,S as me,a7 as xe,D as he,B as be,an as ue,e as I,br as ge,bn as fe,aq as S,o as ye,E as ve,H as je,b as _e}from"./vendor-icons-BbbYTgbL.js";import"./vendor-router-DkVvMFVl.js";import"./vendor-charts-CneYNIhr.js";import"./vendor-i18n-lBdt9ta2.js";import"./vendor-clerk-hm2juogq.js";import"./use-breakpoint-l8ceMopP.js";const R=[{id:"all",label:"الكل",icon:g},{id:"judicial",label:"قضائية",icon:me},{id:"contractual",label:"تعاقدية",icon:xe},{id:"financial",label:"مالية",icon:he},{id:"admin",label:"إدارية",icon:be}],P=[{id:"legal-warning",title:"خطاب إنذار قانوني",category:"judicial",description:"إنذار رسمي قبل اتخاذ الإجراءات القانونية",fields:[{key:"recipient_name",label:"اسم المستلم",placeholder:"عبدالله محمد الشمري"},{key:"recipient_title",label:"صفة المستلم",placeholder:"المدير العام"},{key:"recipient_company",label:"جهة المستلم",placeholder:"شركة النور للتجارة"},{key:"amount",label:"المبلغ المطالب به",placeholder:"٥٠,٠٠٠ ريال سعودي"},{key:"debt_reason",label:"سبب المطالبة",placeholder:"فاتورة خدمات غير مسددة"},{key:"days",label:"مهلة السداد (يوم)",placeholder:"١٥"},{key:"client_name",label:"اسم الموكّل",placeholder:"أحمد سعد القحطاني"}],body:`بسم الله الرحمن الرحيم
