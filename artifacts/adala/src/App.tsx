...
const DesignSystemPage     = lazy(() => import("@/pages/platform/design-system"));
...
const clerkProxyUrl = import.meta.env.DEV
  ? undefined
  : (() => {
      const rawProxy = import.meta.env.VITE_CLERK_PROXY_URL;
    ...
    >
      ...
      <AppErrorBoundary>
          <Switch>
            ...
            <Route path="/design-system"><ProtectedRoute><DesignSystemPage /></ProtectedRoute></Route>
