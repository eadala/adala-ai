...
const NAV_SECTIONS: NavSection[] = [
    ...
    groups: [
      {
        ...
        items: [
          ...
          { href: "/payment-center",label: "المدفوعات",         icon: Landmark,       permission: "payments:view" },
  ...
  /* ── 9. رأس المال البشري ────────────────────────────────────────── */
  {
    ...
    color: "#F59E0B",
    items: [
      { href: "/hr-enterprise", label: "HR المؤسسي",          icon: Shield,         permission: "hr:manage" },
      { href: "/hr-center",     label: "مركز الموارد البشرية", icon: Award,          permission: "hr:manage" },
      { href: "/hr-systems",    label: "أنظمة HR",             icon: Building2,      permission: "hr:manage" },
      { href: "/employees",     label: "الموظفون",             icon: UserCog,        permission: "hr:manage" },
      { href: "/attendance",    label: "الحضور والانصراف",     icon: Clock,          permission: "dashboard:view" },
      { href: "/leaves",        label: "الإجازات",             icon: CalendarDays,   permission: "dashboard:view" },
      { href: "/payroll",       label: "الرواتب",              icon: DollarSign,     permission: "payroll:view" },
      { href: "/warnings",      label: "التحقيقات والإنذارات", icon: AlertTriangle,  permission: "hr:manage" },
      { href: "/org-structure", label: "الهيكل الوظيفي",      icon: Network,        permission: "hr:manage" },
    ],
  },
...
const ALL_QUICK_ACTIONS: QuickAction[] = [
  ...
  { id: "new-invoice",   label: "فاتورة",       icon: Receipt,       href: "/invoices/new",             color: "#EC4899", permission: "invoices:create" },
