...
const OPERATING_CENTERS: OperatingCenterDef[] = [
  ...
  /* ─── Platform: Super Admin ─── */
  {
    ...
    items: [
      ...
      { href: "/ai-command-center",  labelKey: "مركز قيادة الذكاء",          icon: Bot },
      ...
      { href: "/production-launch",      labelKey: "مركز إطلاق الإنتاج",          icon: Rocket },
      { href: "/launch-gate",            labelKey: "بوابة الانطلاقة الذكية",       icon: Sparkles },
      { href: "/legal-os",               labelKey: "نظام التشغيل القانوني",        icon: Cpu },
      { href: "/self-healing",           labelKey: "الإصلاح الذاتي",               icon: Activity },
      { href: "/soc",                    labelKey: "مركز العمليات الأمنية (SOC)",   icon: Shield },
      { href: "/audit-center",           labelKey: "مركز التدقيق المؤسسي",         icon: FileText },
      { href: "/executive-dashboard",    labelKey: "لوحة القيادة التنفيذية",       icon: Crown },
    ],
  },
];
