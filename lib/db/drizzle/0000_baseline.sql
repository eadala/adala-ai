...
--> statement-breakpoint
CREATE TABLE "employee_investigations" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"employee_id" uuid NOT NULL,
...
ALTER TABLE "employee_investigations" ADD CONSTRAINT "employee_investigations_employee_id_employees_id_fk" FOREIGN KEY ("employee_id") REFERENCES "public"."employees"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "employee_warnings" ADD CONSTRAINT "employee_warnings_employee_id_employees_id_fk" FOREIGN KEY ("employee_id") REFERENCES "public"."employees"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "office_articles" ADD CONSTRAINT "office_articles_office_id_office_page_id_fk" FOREIGN KEY ("office_id") REFERENCES "public"."office_page"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "office_domains" ADD CONSTRAINT "office_domains_office_id_office_page_id_fk" FOREIGN KEY ("office_id") REFERENCES "public"."office_page"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "office_orders" ADD CONSTRAINT "office_orders_office_id_office_page_id_fk" FOREIGN KEY ("office_id") REFERENCES "public"."office_page"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "office_orders" ADD CONSTRAINT "office_orders_service_id_office_services_id_fk" FOREIGN KEY ("service_id") REFERENCES "public"."office_services"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "office_reviews" ADD CONSTRAINT "office_reviews_office_id_office_page_id_fk" FOREIGN KEY ("office_id") REFERENCES "public"."office_page"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "office_services" ADD CONSTRAINT "office_services_office_id_office_page_id_fk" FOREIGN KEY ("office_id") REFERENCES "public"."office_page"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "office_team" ADD CONSTRAINT "office_team_office_id_office_page_id_fk" FOREIGN KEY ("office_id") REFERENCES "public"."office_page"("id") ON DELETE cascade ON UPDATE no action;